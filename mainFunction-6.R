...
#########################################   WORKING AREA   ####################################    
    ...
    x_text = "table.check.probes <- dcast(e1[[i]], AAAA1111 ~ BBBB2222, length, value.var='CCCC3333')"
    x_text = sub("AAAA1111",name.vds.cCO2,x_text) #CHANGED NAME.VDS.RH TO O2 HERE ###NEED TO SOFT CODE THIS
    ...
    x_text2 = "table.selectedpoints.probes <- dcast(e1[[i]], AAAA1111 ~ BBBB2222, mean, value.var='CCCC3333')"
    x_text2 = sub("AAAA1111",name.vds.cCO2,x_text2) #CHANGED FROM RH FOR MY O2 FULL CALIBRATION ###NEED TO SOFT CODE THIS
